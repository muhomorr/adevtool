...
export const Field1: MessageFns<Field1> = {
  encode(message: Field1, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.info !== undefined) {
      Field1_devinfo.encode(message.info, writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const Field1_devinfo: MessageFns<Field1_devinfo> = {
  encode(message: Field1_devinfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.int !== 0) {
      writer.uint32(8).int32(message.int);
    }
    if (message.deviceInfo !== undefined) {
      Field1_devinfo_info.encode(message.deviceInfo, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Field1_devinfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Field1_devinfo {
    return {
      ...
      deviceInfo: isSet(object.deviceInfo)
        ? Field1_devinfo_info.fromJSON(object.deviceInfo)
        : isSet(object.device_info)
        ? Field1_devinfo_info.fromJSON(object.device_info)
        : undefined,
    };
  },
...
export const Field1_devinfo_info: MessageFns<Field1_devinfo_info> = {
  encode(message: Field1_devinfo_info, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Field1_devinfo_info {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Field2: MessageFns<Field2> = {
  encode(message: Field2, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.info !== undefined) {
      Field2_appinfo.encode(message.info, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Field2 {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Field2_appinfo: MessageFns<Field2_appinfo> = {
  encode(message: Field2_appinfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pkgname !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Field2_appinfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Request: MessageFns<Request> = {
  encode(message: Request, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.field2 !== undefined) {
      Field2.encode(message.field2, writer.uint32(18).fork()).join();
    }
    return writer;
  },
