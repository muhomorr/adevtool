...
export const Map: MessageFns<Map> = {
  encode(message: Map, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.entry).forEach(([key, value]: [string, string]) => {
      Map_EntryEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },
  ...
  fromJSON(object: any): Map {
    return {
      entry: isObject(object.entry)
        ? (globalThis.Object.entries(object.entry) as [string, any][]).reduce(
  ...
  toJSON(message: Map): unknown {
    const obj: any = {};
    if (message.entry) {
      const entries = globalThis.Object.entries(message.entry) as [string, string][];
      if (entries.length > 0) {
        obj.entry = {};
        entries.forEach(([k, v]) => {
          obj.entry[k] = v;
  ...
  fromPartial<I extends Exact<DeepPartial<Map>, I>>(object: I): Map {
    const message = createBaseMap();
    message.entry = (globalThis.Object.entries(object.entry ?? {}) as [string, string][]).reduce(
...
export const Map_EntryEntry: MessageFns<Map_EntryEntry> = {
  encode(message: Map_EntryEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Map_EntryEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CarrierSettings: MessageFns<CarrierSettings> = {
  encode(message: CarrierSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.cfg) {
      CarrierSettings_Configs.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.msg2 !== undefined) {
      CarrierSettings_k.encode(message.msg2, writer.uint32(26).fork()).join();
    }
    if (message.j !== "") {
...
export const CarrierSettings_unk1: MessageFns<CarrierSettings_unk1> = {
  encode(message: CarrierSettings_unk1, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.n !== undefined) {
      Map.encode(message.n, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CarrierSettings_unk1 {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CarrierSettings_Configs: MessageFns<CarrierSettings_Configs> = {
  encode(message: CarrierSettings_Configs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    if (message.unk1 !== undefined) {
      CarrierSettings_unk1.encode(message.unk1, writer.uint32(50).fork()).join();
    }
    if (message.ext !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CarrierSettings_Configs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CarrierSettings_k: MessageFns<CarrierSettings_k> = {
  encode(message: CarrierSettings_k, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.l !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CarrierSettings_k {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Field1: MessageFns<Field1> = {
  encode(message: Field1, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.entry).forEach(([key, value]: [string, number]) => {
      Field1_EntryEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    if (message.settings !== undefined) {
      CarrierSettings.encode(message.settings, writer.uint32(18).fork()).join();
    }
    if (message.q !== undefined) {
      Map.encode(message.q, writer.uint32(26).fork()).join();
    }
    if (message.s !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Field1 {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: Field1): unknown {
    const obj: any = {};
    if (message.entry) {
      const entries = globalThis.Object.entries(message.entry) as [string, number][];
      if (entries.length > 0) {
        obj.entry = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Field1>, I>>(object: I): Field1 {
    const message = createBaseField1();
    message.entry = (globalThis.Object.entries(object.entry ?? {}) as [string, number][]).reduce(
...
export const Field1_EntryEntry: MessageFns<Field1_EntryEntry> = {
  encode(message: Field1_EntryEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Field1_EntryEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Response: MessageFns<Response> = {
  encode(message: Response, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.field1 !== undefined) {
      Field1.encode(message.field1, writer.uint32(10).fork()).join();
    }
