...
export const CarrierId: MessageFns<CarrierId> = {
  encode(message: CarrierId, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CarrierId {
  ...
  fromJSON(object: any): CarrierId {
    return {
      mccMnc: isSet(object.mccMnc)
        ? globalThis.String(object.mccMnc)
        : isSet(object.mcc_mnc)
        ? globalThis.String(object.mcc_mnc)
        : "",
...
export const CarrierMap: MessageFns<CarrierMap> = {
  encode(message: CarrierMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.carrierId) {
      CarrierId.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CarrierMap {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CarrierMap {
    return {
      ...
      carrierId: globalThis.Array.isArray(object?.carrierId)
        ...
        : globalThis.Array.isArray(object?.carrier_id)
        ? object.carrier_id.map((e: any) => CarrierId.fromJSON(e))
        : [],
    };
  },
...
export const CarrierList: MessageFns<CarrierList> = {
  encode(message: CarrierList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.entry) {
      CarrierMap.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CarrierList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
