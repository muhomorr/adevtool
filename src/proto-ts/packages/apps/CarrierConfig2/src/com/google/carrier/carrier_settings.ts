...
export const CarrierSettings: MessageFns<CarrierSettings> = {
  encode(message: CarrierSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.apns !== undefined) {
      CarrierApns.encode(message.apns, writer.uint32(26).fork()).join();
    }
    if (message.configs !== undefined) {
      CarrierConfig.encode(message.configs, writer.uint32(34).fork()).join();
    }
    if (message.vendorConfigs !== undefined) {
      VendorConfigs.encode(message.vendorConfigs, writer.uint32(50).fork()).join();
    }
    if (message.lastUpdated !== undefined) {
      Timestamp.encode(message.lastUpdated, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CarrierSettings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CarrierSettings {
    return {
      canonicalName: isSet(object.canonicalName)
        ? globalThis.String(object.canonicalName)
        : isSet(object.canonical_name)
        ? globalThis.String(object.canonical_name)
        : "",
      ...
      vendorConfigs: isSet(object.vendorConfigs)
        ? VendorConfigs.fromJSON(object.vendorConfigs)
        : isSet(object.vendor_configs)
        ? VendorConfigs.fromJSON(object.vendor_configs)
        : undefined,
      lastUpdated: isSet(object.lastUpdated)
        ? Timestamp.fromJSON(object.lastUpdated)
        : isSet(object.last_updated)
        ? Timestamp.fromJSON(object.last_updated)
        : undefined,
    };
  },
...
export const MultiCarrierSettings: MessageFns<MultiCarrierSettings> = {
  encode(message: MultiCarrierSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.version !== undefined && message.version !== 0) {
      writer.uint32(8).int64(message.version);
    }
    for (const v of message.setting) {
      CarrierSettings.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.lastUpdated !== undefined) {
      Timestamp.encode(message.lastUpdated, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MultiCarrierSettings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ApnItem: MessageFns<ApnItem> = {
  encode(message: ApnItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ApnItem {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ApnItem {
    return {
      ...
      bearerBitmask: isSet(object.bearerBitmask)
        ? globalThis.String(object.bearerBitmask)
        : isSet(object.bearer_bitmask)
        ? globalThis.String(object.bearer_bitmask)
        : "0",
      ...
      mmscProxy: isSet(object.mmscProxy)
        ? globalThis.String(object.mmscProxy)
        : isSet(object.mmsc_proxy)
        ? globalThis.String(object.mmsc_proxy)
        : "",
      mmscProxyPort: isSet(object.mmscProxyPort)
        ? globalThis.String(object.mmscProxyPort)
        : isSet(object.mmsc_proxy_port)
        ? globalThis.String(object.mmsc_proxy_port)
        : "",
      protocol: isSet(object.protocol) ? apnItem_ProtocolFromJSON(object.protocol) : 0,
      roamingProtocol: isSet(object.roamingProtocol)
        ? apnItem_ProtocolFromJSON(object.roamingProtocol)
        : isSet(object.roaming_protocol)
        ? apnItem_ProtocolFromJSON(object.roaming_protocol)
        : 0,
      mtu: isSet(object.mtu) ? globalThis.Number(object.mtu) : 0,
      profileId: isSet(object.profileId)
        ? globalThis.Number(object.profileId)
        : isSet(object.profile_id)
        ? globalThis.Number(object.profile_id)
        : 0,
      maxConns: isSet(object.maxConns)
        ? globalThis.Number(object.maxConns)
        : isSet(object.max_conns)
        ? globalThis.Number(object.max_conns)
        : 0,
      waitTime: isSet(object.waitTime)
        ? globalThis.Number(object.waitTime)
        : isSet(object.wait_time)
        ? globalThis.Number(object.wait_time)
        : 0,
      maxConnsTime: isSet(object.maxConnsTime)
        ? globalThis.Number(object.maxConnsTime)
        : isSet(object.max_conns_time)
        ? globalThis.Number(object.max_conns_time)
        : 0,
      modemCognitive: isSet(object.modemCognitive)
        ? globalThis.Boolean(object.modemCognitive)
        : isSet(object.modem_cognitive)
        ? globalThis.Boolean(object.modem_cognitive)
        : false,
      userVisible: isSet(object.userVisible)
        ? globalThis.Boolean(object.userVisible)
        : isSet(object.user_visible)
        ? globalThis.Boolean(object.user_visible)
        : true,
      userEditable: isSet(object.userEditable)
        ? globalThis.Boolean(object.userEditable)
        : isSet(object.user_editable)
        ? globalThis.Boolean(object.user_editable)
        : true,
      apnSetId: isSet(object.apnSetId)
        ? globalThis.Number(object.apnSetId)
        : isSet(object.apn_set_id)
        ? globalThis.Number(object.apn_set_id)
        : 0,
      skip464xlat: isSet(object.skip464xlat)
        ? apnItem_XlatFromJSON(object.skip464xlat)
        : isSet(object.skip_464xlat)
        ? apnItem_XlatFromJSON(object.skip_464xlat)
        : 0,
      lingeringNetworkTypeBitmask: isSet(object.lingeringNetworkTypeBitmask)
        ? globalThis.String(object.lingeringNetworkTypeBitmask)
        : isSet(object.lingering_network_type_bitmask)
        ? globalThis.String(object.lingering_network_type_bitmask)
        : "0",
      alwaysOn: isSet(object.alwaysOn)
        ? globalThis.Boolean(object.alwaysOn)
        : isSet(object.always_on)
        ? globalThis.Boolean(object.always_on)
        : false,
      mtuV6: isSet(object.mtuV6)
        ? globalThis.Number(object.mtuV6)
        : isSet(object.mtu_v6)
        ? globalThis.Number(object.mtu_v6)
        : 0,
      infrastructureBitmask: isSet(object.infrastructureBitmask)
        ? globalThis.Number(object.infrastructureBitmask)
        : isSet(object.infrastructure_bitmask)
        ? globalThis.Number(object.infrastructure_bitmask)
        : 3,
      esimBootstrapProvisioning: isSet(object.esimBootstrapProvisioning)
        ? globalThis.Number(object.esimBootstrapProvisioning)
        : isSet(object.esim_bootstrap_provisioning)
        ? globalThis.Number(object.esim_bootstrap_provisioning)
        : 0,
    };
  },
...
export const CarrierApns: MessageFns<CarrierApns> = {
  encode(message: CarrierApns, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.apn) {
      ApnItem.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CarrierApns {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CarrierConfig: MessageFns<CarrierConfig> = {
  encode(message: CarrierConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.config) {
      CarrierConfig_Config.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CarrierConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const CarrierConfig_Config: MessageFns<CarrierConfig_Config> = {
  encode(message: CarrierConfig_Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.textArray !== undefined) {
      TextArray.encode(message.textArray, writer.uint32(50).fork()).join();
    }
    if (message.intArray !== undefined) {
      IntArray.encode(message.intArray, writer.uint32(58).fork()).join();
    }
    if (message.bundle !== undefined) {
      CarrierConfig.encode(message.bundle, writer.uint32(66).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CarrierConfig_Config {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CarrierConfig_Config {
    return {
      ...
      longValue: isSet(object.longValue)
        ? globalThis.Number(object.longValue)
        : isSet(object.long_value)
        ? globalThis.Number(object.long_value)
        : undefined,
      boolValue: isSet(object.boolValue)
        ...
        : undefined,
      textArray: isSet(object.textArray)
        ? TextArray.fromJSON(object.textArray)
        : isSet(object.text_array)
        ? TextArray.fromJSON(object.text_array)
        : undefined,
      intArray: isSet(object.intArray)
        ? IntArray.fromJSON(object.intArray)
        : isSet(object.int_array)
        ? IntArray.fromJSON(object.int_array)
        : undefined,
...
export const VendorConfigClient: MessageFns<VendorConfigClient> = {
  encode(message: VendorConfigClient, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VendorConfigClient {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const VendorConfigs: MessageFns<VendorConfigs> = {
  encode(message: VendorConfigs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.client) {
      VendorConfigClient.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): VendorConfigs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
